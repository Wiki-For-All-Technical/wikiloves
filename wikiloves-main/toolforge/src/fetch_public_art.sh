...
echo "============================================"
echo "  Wiki Loves Public Art - Bulk Data Fetcher"
echo "  Output: $OUTDIR"
echo "============================================"

PREFIX="Images_from_Wiki_Loves_Public_Art"
...
for y in $(seq 2012 2025); do
    fetch_campaign_year "public_art" "$y"
done
...
WHERE cl.cl_to LIKE '${PREFIX}_%'
  ...
  AND cl.cl_to NOT LIKE '%_at_%'
GROUP BY cl.cl_to
" > "${OUTDIR}/public_art_images_used.tsv"
echo "  -> images_used saved to ${OUTDIR}/public_art_images_used.tsv"

echo ""
echo "============================================"
echo "  Public Art fetch complete!"
echo "============================================"
echo "TSV files:"
ls -lh "${OUTDIR}"/public_art_*.tsv 2>/dev/null
echo ""
echo "Next step: python3 ~/process_all.py public_art"
