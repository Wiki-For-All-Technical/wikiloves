...
echo "============================================"
echo "  Wiki Loves Africa - Bulk Data Fetcher"
echo "  Output: $OUTDIR"
echo "============================================"

PREFIX="Images_from_Wiki_Loves_Africa"
...
WHERE cl.cl_to LIKE '${PREFIX}_%'
  ...
  AND cl.cl_to NOT LIKE '%_at_%'
GROUP BY cl.cl_to
" > "${OUTDIR}/africa_images_used.tsv"
echo "  -> images_used saved to ${OUTDIR}/africa_images_used.tsv"

echo ""
echo "============================================"
echo "  Africa fetch complete!"
echo "============================================"
echo "TSV files:"
ls -lh "${OUTDIR}"/africa_*.tsv 2>/dev/null
echo ""
echo "Next step: python3 ~/process_all.py africa"
