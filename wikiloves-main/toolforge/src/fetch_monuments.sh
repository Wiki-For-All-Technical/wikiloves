...
echo "============================================"
echo "  Wiki Loves Monuments - Bulk Data Fetcher"
echo "  Output: $OUTDIR"
echo "============================================"

PREFIX="Images_from_Wiki_Loves_Monuments"
...
for y in $(seq 2010 2025); do
    fetch_campaign_year "monuments" "$y"
done
...
WHERE cl.cl_to LIKE '${PREFIX}_%'
  ...
  AND cl.cl_to NOT LIKE '%_at_%'
GROUP BY cl.cl_to
" > "${OUTDIR}/monuments_images_used.tsv"
echo "  -> images_used saved to ${OUTDIR}/monuments_images_used.tsv"

echo ""
echo "============================================"
echo "  Monuments fetch complete!"
echo "============================================"
echo "TSV files:"
ls -lh "${OUTDIR}"/monuments_*.tsv 2>/dev/null
echo ""
echo "Next step: python3 ~/process_all.py monuments"
