...
echo "============================================"
echo "  Wiki Loves Food - Bulk Data Fetcher"
echo "  Output: $OUTDIR"
echo "============================================"

PREFIX="Images_from_Wiki_Loves_Food"
...
for y in $(seq 2021 2025); do
    fetch_campaign_year "food" "$y"
done
...
WHERE cl.cl_to LIKE '${PREFIX}_%'
  ...
  AND cl.cl_to NOT LIKE '%_at_%'
GROUP BY cl.cl_to
" > "${OUTDIR}/food_images_used.tsv"
echo "  -> images_used saved to ${OUTDIR}/food_images_used.tsv"

echo ""
echo "============================================"
echo "  Food fetch complete!"
echo "============================================"
echo "TSV files:"
ls -lh "${OUTDIR}"/food_*.tsv 2>/dev/null
echo ""
echo "Next step: python3 ~/process_all.py food"
