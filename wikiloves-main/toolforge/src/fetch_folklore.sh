...
echo "============================================"
echo "  Wiki Loves Folklore - Bulk Data Fetcher"
echo "  Output: $OUTDIR"
echo "============================================"

PREFIX="Images_from_Wiki_Loves_Folklore"
...
for y in $(seq 2021 2026); do
    fetch_campaign_year "folklore" "$y"
done
...
WHERE cl.cl_to LIKE '${PREFIX}_%'
  ...
  AND cl.cl_to NOT LIKE '%_at_%'
GROUP BY cl.cl_to
" > "${OUTDIR}/folklore_images_used.tsv"
echo "  -> images_used saved to ${OUTDIR}/folklore_images_used.tsv"

echo ""
echo "============================================"
echo "  Folklore fetch complete!"
echo "============================================"
echo "TSV files:"
ls -lh "${OUTDIR}"/folklore_*.tsv 2>/dev/null
echo ""
echo "Next step: python3 ~/process_all.py folklore"
