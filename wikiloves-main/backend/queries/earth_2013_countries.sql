-- ============================================
-- WIKI LOVES EARTH 2013 - COUNTRY STATISTICS
-- ============================================
-- Gets statistics broken down by country for year 2013
...
-- https://wikiloves.toolforge.org/earth/2013
...
SELECT 
    ...
    COUNT(DISTINCT CASE 
        WHEN u.user_registration >= CONCAT(2013, '0501000000')
            AND u.user_registration <= CONCAT(2013, '0531235959')
        THEN a.actor_name
