-- ============================================
-- WIKI LOVES EARTH 2025 - COUNTRY STATISTICS
-- ============================================
-- Gets statistics broken down by country for year 2025
...
-- https://wikiloves.toolforge.org/earth/2025
...
SELECT 
    ...
    COUNT(DISTINCT CASE 
        WHEN u.user_registration >= CONCAT(2025, '0501000000')
            AND u.user_registration <= CONCAT(2025, '0531235959')
        THEN a.actor_name
