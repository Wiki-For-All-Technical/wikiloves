-- ============================================
-- WIKI LOVES EARTH 2016 - COUNTRY STATISTICS
-- ============================================
-- Gets statistics broken down by country for year 2016
...
-- https://wikiloves.toolforge.org/earth/2016
...
SELECT 
    ...
    COUNT(DISTINCT CASE 
        WHEN u.user_registration >= CONCAT(2016, '0501000000')
            AND u.user_registration <= CONCAT(2016, '0531235959')
        THEN a.actor_name
