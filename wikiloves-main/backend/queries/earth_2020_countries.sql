-- ============================================
-- WIKI LOVES EARTH 2020 - COUNTRY STATISTICS
-- ============================================
-- Gets statistics broken down by country for year 2020
...
-- https://wikiloves.toolforge.org/earth/2020
...
SELECT 
    ...
    COUNT(DISTINCT CASE 
        WHEN u.user_registration >= CONCAT(2020, '0501000000')
            AND u.user_registration <= CONCAT(2020, '0531235959')
        THEN a.actor_name
