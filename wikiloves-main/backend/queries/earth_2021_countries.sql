-- ============================================
-- WIKI LOVES EARTH 2021 - COUNTRY STATISTICS
-- ============================================
-- Gets statistics broken down by country for year 2021
...
-- https://wikiloves.toolforge.org/earth/2021
...
SELECT 
    ...
    COUNT(DISTINCT CASE 
        WHEN u.user_registration >= CONCAT(2021, '0501000000')
            AND u.user_registration <= CONCAT(2021, '0531235959')
        THEN a.actor_name
