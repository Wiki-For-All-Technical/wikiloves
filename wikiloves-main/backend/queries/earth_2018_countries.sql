-- ============================================
-- WIKI LOVES EARTH 2018 - COUNTRY STATISTICS
-- ============================================
-- Gets statistics broken down by country for year 2018
...
-- https://wikiloves.toolforge.org/earth/2018
...
SELECT 
    ...
    COUNT(DISTINCT CASE 
        WHEN u.user_registration >= CONCAT(2018, '0501000000')
            AND u.user_registration <= CONCAT(2018, '0531235959')
        THEN a.actor_name
