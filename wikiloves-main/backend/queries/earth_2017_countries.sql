-- ============================================
-- WIKI LOVES EARTH 2017 - COUNTRY STATISTICS
-- ============================================
-- Gets statistics broken down by country for year 2017
...
-- https://wikiloves.toolforge.org/earth/2017
...
SELECT 
    ...
    COUNT(DISTINCT CASE 
        WHEN u.user_registration >= CONCAT(2017, '0501000000')
            AND u.user_registration <= CONCAT(2017, '0531235959')
        THEN a.actor_name
