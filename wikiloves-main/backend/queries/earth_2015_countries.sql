-- ============================================
-- WIKI LOVES EARTH 2015 - COUNTRY STATISTICS
-- ============================================
-- Gets statistics broken down by country for year 2015
...
-- https://wikiloves.toolforge.org/earth/2015
...
SELECT 
    ...
    COUNT(DISTINCT CASE 
        WHEN u.user_registration >= CONCAT(2015, '0501000000')
            AND u.user_registration <= CONCAT(2015, '0531235959')
        THEN a.actor_name
