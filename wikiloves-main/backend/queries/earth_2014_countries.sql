-- ============================================
-- WIKI LOVES EARTH 2014 - COUNTRY STATISTICS
-- ============================================
-- Gets statistics broken down by country for year 2014
...
-- https://wikiloves.toolforge.org/earth/2014
...
SELECT 
    ...
    COUNT(DISTINCT CASE 
        WHEN u.user_registration >= CONCAT(2014, '0501000000')
            AND u.user_registration <= CONCAT(2014, '0531235959')
        THEN a.actor_name
