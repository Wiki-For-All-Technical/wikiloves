-- ============================================
-- WIKI LOVES EARTH 2023 - COUNTRY STATISTICS
-- ============================================
-- Gets statistics broken down by country for year 2023
...
-- https://wikiloves.toolforge.org/earth/2023
...
SELECT 
    ...
    COUNT(DISTINCT CASE 
        WHEN u.user_registration >= CONCAT(2023, '0501000000')
            AND u.user_registration <= CONCAT(2023, '0531235959')
        THEN a.actor_name
