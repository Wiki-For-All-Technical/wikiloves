-- ============================================
-- WIKI LOVES EARTH 2024 - COUNTRY STATISTICS
-- ============================================
-- Gets statistics broken down by country for year 2024
...
-- https://wikiloves.toolforge.org/earth/2024
...
SELECT 
    ...
    COUNT(DISTINCT CASE 
        WHEN u.user_registration >= CONCAT(2024, '0501000000')
            AND u.user_registration <= CONCAT(2024, '0531235959')
        THEN a.actor_name
