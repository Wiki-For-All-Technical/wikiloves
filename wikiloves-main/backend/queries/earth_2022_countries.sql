-- ============================================
-- WIKI LOVES EARTH 2022 - COUNTRY STATISTICS
-- ============================================
-- Gets statistics broken down by country for year 2022
...
SELECT 
    ...
    COUNT(DISTINCT CASE 
        WHEN u.user_registration >= CONCAT(2022, '0501000000')
            AND u.user_registration <= CONCAT(2022, '0531235959')
        THEN a.actor_name
